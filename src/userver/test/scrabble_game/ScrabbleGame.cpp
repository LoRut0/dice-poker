...
std::vector<std::u32string> ScrabbleGame::GetNewWords_(
    std::vector<std::vector<std::optional<Tile>>> &new_board,
...
int ScrabbleGame::get_letter_score_(const char32_t &letter) {
  switch (letter) {
  case U'А':
    return 1;
  case U'Б':
